...
% Return the parameters from the ABCD matrix
...
if isnan(Ein.Field)
    error('Fit_TEM00(): NaN present in the electrical field')
end
...
elseif p.Results.With_ABCD % return directly the values from the ABCD matrix
